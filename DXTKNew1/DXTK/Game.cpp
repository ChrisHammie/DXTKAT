...
void Game::Render()
{
	...
	m_spriteBatch->Draw(m_texture.Get(), m_screenPos, nullptr, Colors::White,0.0f, m_origin, cosf(time) +2.0f);
...
void Game::CreateDevice()
{
	...
	m_origin.x = float(m_outputWidth / 2);
	m_origin.y = float(m_outputHeight / 2);
